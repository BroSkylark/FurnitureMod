...
public abstract class Reference
{
    ...
    public static final String MOD_VERSION = "a0.6";
    ...
    public static final String ITEM_BAG_NAME = "Bag";
    ...
    public static final String CONTAINER_BAG_NAME = CONTAINER + ITEM_BAG_NAME;
